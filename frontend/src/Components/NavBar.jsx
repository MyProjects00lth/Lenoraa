          ...
          <div className="navbar-nav me-auto mb-2 mb-lg-0" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '20px', flexDirection: isMobile ? 'column' : 'row' }}>
            <ul style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', listStyle: 'none', padding: 0, margin: 0 }}>
              <li className="nav-item" style={{ margin: isMobile ? '10px 0' : '0 15px' }}>
                <a className="nav-link active" aria-current="page" href="/" style={{textDecoration: 'none', color: 'black'}}>HOME</a>
              </li>
              <li className="nav-item" style={{ margin: isMobile ? '10px 0' : '0 15px' }}>
                <a className="nav-link active" aria-current="page" href="#" style={{textDecoration: 'none', color: 'black'}}>GALLERY</a>
              </li>
              <li className="nav-item" style={{ margin: isMobile ? '10px 0' : '0 15px' }}>
                <a className="nav-link active" aria-current="page" href="#" style={{textDecoration: 'none', color: 'black'}}>ABOUT ME</a>
              </li>
              <li className="nav-item" style={{ margin: isMobile ? '10px 0' : '0 15px' }}>
                <a className="nav-link active" aria-current="page" href="#" style={{textDecoration: 'none', color: 'black'}}>CONTACT ME</a>
              </li>
            </ul>
          </div>
        </center>
